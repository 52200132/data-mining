...
def load_dataset(path: str = "data/processed/dataset_final.jsonl"):
    texts, labels = [], []
...
TOPIC_KEYWORDS = {
    "Thể thao": [
        "bóng_đá", "cầu_thủ", "giải_đấu", "trận_đấu", "vận_động_viên",
        "huy_chương", "thể_thao", "bàn_thắng", "câu_lạc_bộ", "hlv",
        "vô_địch", "tuyển", "huấn_luyện_viên", "sân_vận_động", "tennis",
        "bơi_lội", "điền_kinh", "bóng_rổ", "cầu_lông", "đua_xe",
    ],
    "Kinh doanh": [
        "doanh_nghiệp", "thị_trường", "chứng_khoán", "tài_chính",
        "ngân_hàng", "lợi_nhuận", "đầu_tư", "xuất_khẩu", "gdp",
        "cổ_phiếu", "doanh_thu", "kinh_doanh", "bất_động_sản",
        "khởi_nghiệp", "startup", "thương_mại", "nhập_khẩu",
    ],
    "Pháp luật": [
        "tòa_án", "bị_cáo", "xét_xử", "tội_phạm", "hình_sự",
        "điều_tra", "bắt_giữ", "luật", "phiên_tòa", "kết_án",
        "công_an", "cơ_quan_điều_tra", "bản_án", "vi_phạm",
        "khởi_tố", "truy_tố", "thi_hành_án", "phạt_tù",
    ],
    "Công nghệ": [
        "công_nghệ", "phần_mềm", "trí_tuệ_nhân_tạo", "smartphone",
        "ai", "internet", "robot", "ứng_dụng", "kỹ_thuật_số",
        "chip", "điện_thoại", "máy_tính", "dữ_liệu", "chatgpt",
        "mạng_xã_hội", "iphone", "android", "cybersecurity", "blockchain",
    ],
    "Giải trí": [
        "nghệ_sĩ", "âm_nhạc", "phim", "ca_sĩ", "diễn_viên",
        "showbiz", "nhạc", "điện_ảnh", "hoa_hậu", "sao",
        "concert", "album", "gameshow", "truyền_hình", "đạo_diễn",
        "rapper", "idol", "liveshow", "mv", "phim_truyện",
    ],
    "Chính trị - Xã hội": [
        "chính_phủ", "bộ_trưởng", "nghị_quyết", "chính_sách",
        "xã_hội", "dân_sinh", "giao_thông", "quy_định", "nhà_nước",
        "quốc_hội", "ủy_ban", "hội_đồng", "nghị_định", "thủ_tướng",
        "đề_xuất", "chủ_tịch", "bộ", "sở", "phường_xã",
    ],
    "Sức khỏe": [
        "bệnh_viện", "bác_sĩ", "bệnh_nhân", "sức_khỏe", "y_tế",
        "vaccine", "điều_trị", "thuốc", "dịch_bệnh", "phẫu_thuật",
        "ung_thư", "tim_mạch", "đái_tháo_đường", "dinh_dưỡng",
        "covid", "virus", "kháng_sinh", "nội_soi", "xét_nghiệm",
    ],
    "Du lịch": [
        "du_lịch", "khách_sạn", "điểm_đến", "tour", "resort",
        "biển", "di_tích", "tham_quan", "danh_lam", "khách_du_lịch",
        "đặt_phòng", "visa", "hành_lý", "phong_cảnh", "ẩm_thực",
        "homestay", "cảnh_quan", "vé_máy_bay", "checkin", "backpacker",
    ],
    "Giáo dục": [
        "học_sinh", "sinh_viên", "trường", "giáo_viên", "đại_học",
        "thi_cử", "giáo_dục", "chương_trình", "tuyển_sinh", "bộ_giáo_dục",
        "học_bổng", "điểm_số", "kỳ_thi", "phụ_huynh", "lớp_học",
        "thpt", "thcs", "trung_học", "đề_thi", "tiến_sĩ",
    ],
    "Khoa học": [
        "nghiên_cứu", "khoa_học", "phát_hiện", "vũ_trụ", "gen",
        "tế_bào", "thí_nghiệm", "nhà_khoa_học", "công_trình", "dna",
        "hành_tinh", "thiên_văn", "vật_lý", "hóa_học", "sinh_học",
        "tiến_hóa", "biến_đổi_khí_hậu", "năng_lượng", "phân_tử", "não",
    ],
}
...
def plot_top_keywords(vectorizer, model, class_names: list, output_dir: Path, top_n: int = 15):
    ...
    plt.tight_layout()
    path = output_dir / "top_keywords.png"
    plt.savefig(path, dpi=150, bbox_inches="tight")
...
if __name__ == "__main__":
    ...
    # Load data
    texts, labels = load_dataset("data/processed/dataset_final.jsonl")
